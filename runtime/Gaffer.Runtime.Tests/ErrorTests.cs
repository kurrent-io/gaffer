...
public class ErrorTests {
	...
	public Task InvalidProjectionError_parse_error_with_location() {
		...
		var ex = Assert.Throws<InvalidProjectionException>(() => new ProjectionSession(source));
	...
	public Task InvalidProjectionError_source_definition_error() {
		var ex = Assert.Throws<InvalidProjectionException>(() => new ProjectionSession("fromStream(123)"));
