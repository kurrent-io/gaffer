...
Low-level Node.js bindings for the gaffer projection runtime. Runs the same JavaScript engine KurrentDB uses for server-side projections, wrapping the NativeAOT shared library.
