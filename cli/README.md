...
- **VS Code** - install the [KurrentDB Projections extension](https://marketplace.visualstudio.com/items?itemName=kurrent-io.gaffer-vscode) for inline diagnostics, run/debug codelens above `gaffer.toml` projections, and breakpoint debugging.
