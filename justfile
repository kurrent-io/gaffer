...
[private]
[parallel]
_init-modules: runtime::init bindings::init testing::init editors::init
...
[private]
[parallel]
_build: cli::build bindings::build testing::build editors::build
...
[private]
[parallel]
_test: runtime::test bindings::test cli::test testing::test editors::test
...
[parallel]
fix: runtime::fix bindings::fix cli::fix testing::fix editors::fix

# Check formatting and linting across all projects
[parallel]
check: runtime::check bindings::check cli::check testing::check editors::check

# Remove build artifacts across all projects
[parallel]
clean: runtime::clean bindings::clean cli::clean testing::clean editors::clean
