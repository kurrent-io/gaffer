...
- **VS Code** - install the KurrentDB Projections extension from the [VS Code Marketplace](https://marketplace.visualstudio.com/items?itemName=kurrent-io.gaffer-vscode) or [Open VSX](https://open-vsx.org/extension/kurrent-io/gaffer-vscode) for inline diagnostics, run/debug codelens above `gaffer.toml` projections, and breakpoint debugging.
