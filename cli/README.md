...
The command-line toolkit for [KurrentDB](https://www.kurrent.io) projections (`@kurrent/gaffer` on npm). Scaffold, run, debug, and deploy projections from your terminal.
